        ...
        where TUser : IAppUser, new()
    {
        ...
        public IAppUser FindBySubjectId(string subjectId)
        {
            ...
            if (result.HasValue)
            {
                ...
                IAppUser foundSubjectId = JsonSerializer.Deserialize<TUser>(result.ToString(), _jsonSerializerSettings);
        ...
        public IAppUser FindByUsername(string username)
        {
            ...
            if (result.HasValue)
            {
                ...
                {
                    // IMPORTANT! This line might throw an exception if we change the format/version
                    IAppUser foundSubjectId = JsonSerializer.Deserialize<TUser>(subject.ToString(), _jsonSerializerSettings);
        ...
        private void SetRedisData(IAppUser user)
        {
            ...
            var userStr = JsonSerializer.Serialize(user, _jsonSerializerSettings);
