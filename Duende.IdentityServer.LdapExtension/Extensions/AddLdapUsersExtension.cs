using Duende.IdentityServer.LdapExtension;
using Duende.IdentityServer.LdapExtension.UserModel;
using Duende.IdentityServer.LdapExtension.UserStore;
using Duende.IdentityServer.LdapExtension.Extensions;
...
namespace IdentityServer.LdapExtension.Extensions
{
    public static class AddLdapUsersExtension
    {
        ...
        /// </returns>
        public static IIdentityServerBuilder AddLdapUsers<TUserDetails>(this IIdentityServerBuilder builder, IConfiguration configuration, Duende.IdentityServer.LdapExtension.Extensions.UserStore userStore)
            where TUserDetails : IAppUser, new()
        {
            ...
            if (userStore == Duende.IdentityServer.LdapExtension.Extensions.UserStore.InMemory)
            {
